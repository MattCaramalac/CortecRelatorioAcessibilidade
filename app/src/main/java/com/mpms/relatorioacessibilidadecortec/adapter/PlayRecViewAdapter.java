...
public class PlayRecViewAdapter extends RecyclerView.Adapter<ViewHolderInterface.ListViewHolder> implements DeleteInterface, ViewHolderInterface {
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
       PlaygroundEntry playground = playList.get(position);
        if (playground != null) {
            holder.textInfoOne.setText(playgroundLocation(playground));
            holder.textInfoTwo.setText(playgroundNumber(getItemCount()-position));
