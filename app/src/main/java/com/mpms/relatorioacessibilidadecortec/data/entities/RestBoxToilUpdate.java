...
@Entity
public class RestBoxToilUpdate {
    ...
    public RestBoxToilUpdate(int boxID, Integer toType, Double toHeightNoSeat, Integer toHasSeat, Double toHeightSeat, Integer toHasSoculo, Double frSoculo, Double latSoculo,
                             ...
                             Integer hasHorBar, Double horBarD, Double horBarE, Double horBarF, Double horBarDistG, Double horBarSect, Double horBarDist, Integer hasVertBar,
