...
public class SingleStepLeftHandFragment extends Fragment implements TagInterface, RadioGroupInterface {
    ...
    public SingleStepLeftHandFragment() {
        // Required empty public constructor
    }


    public static SingleStepLeftHandFragment newInstance() {
        return new SingleStepLeftHandFragment();
    }
...
//        Layout
    ...
    private void loadSingleStepHandData(SingleStepEntry step) {
        if (step.getLeftHandUpHeight() != null)
            upHandHeightValue.setText(String.valueOf(step.getLeftHandUpHeight()));
        if (step.getLeftHandDownHeight() != null)
            lowHandHeightValue.setText(String.valueOf(step.getLeftHandDownHeight()));
        if (step.getLeftHandDiam() != null)
            diamValue.setText(String.valueOf(step.getLeftHandDiam()));
        if (step.getLeftHandDist() != null)
            distValue.setText(String.valueOf(step.getLeftHandDist()));
        if (step.getLeftHasLowerExt() != null) {
            checkRadioGroup(lowExtRadio, step.getLeftHasLowerExt());
            if (step.getLeftHasLowerExt() == 1) {
                if (step.getLeftLowerUpLength() != null)
                    upStartExtValue.setText(String.valueOf(step.getLeftLowerUpLength()));
                if (step.getLeftLowerDownLength() != null)
                    lowStartExtValue.setText(String.valueOf(step.getLeftLowerDownLength()));
            }
        }
        if (step.getLeftHasUpperExt() != null) {
            checkRadioGroup(upExtRadio, step.getLeftHasUpperExt());
            if (step.getLeftHasLowerExt() == 1) {
                if (step.getLeftUpperUpLength() != null)
                    upEndExtValue.setText(String.valueOf(step.getLeftUpperUpLength()));
                if (step.getLeftLowerDownLength() != null)
                    lowEndExtValue.setText(String.valueOf(step.getLeftUpperDownLength()));
            }
        }
    }
