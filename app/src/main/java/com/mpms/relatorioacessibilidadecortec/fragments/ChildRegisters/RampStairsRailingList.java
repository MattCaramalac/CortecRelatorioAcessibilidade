...
public class RampStairsRailingList extends Fragment implements OnEntryClickListener, TagInterface {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelEntry.getRampStairsRailings(railListBundle.getInt(FLIGHT_ID)).observe(getViewLifecycleOwner(), handList -> {
            ...
            listCreator(railAdapter, handList);
        });
...
//        RecyclerView
    ...
    private <T> void listCreator(RailingRecViewAdapter adapter, List<T> entries) {
        ...
        if (actionMode == null) {
            ...
            actionMode = activity.startSupportActionMode(new ActionMode.Callback() {
                ...
                public void onDestroyActionMode(ActionMode mode) {
                    if (delClick == 0)
                        railAdapter.cancelSelection(recyclerView, entries, railAdapter);
